<template>
    <div>
            ...
            <div class="flex justify-between items-center h-full">
              <div class="flex items-center md:space-x-4 space-x-4 rtl:space-x-reverse vertical-box">
                <a href="#" class="mobile-logo xl:hidden inline-block">
                  <img :src="url + 'template_assets/images/logo/logo-c.svg'" class="black_logo" alt="logo">
                  <img :src="url + 'template_assets/images/logo/logo-c-white.svg'" class="white_logo" alt="logo">
                </a>
        ...
        <img :src="url + 'template_assets/images/logo/logo.svg'" class="black_logo " alt="logo">
        <img :src="url + 'template_assets/images/logo/logo-white.svg'" class="white_logo" alt="logo">
    </span>
      ...
      dark:bg-slate-800 border dark:border-slate-900 !top-[23px] rounded-md overflow-hidden lrt:origin-top-right rtl:origin-top-left">
                ...
                right-0 top-0"></span>
                              <img :src="'/template_assets/images/all-img/user.png'" alt="user" class="block w-full h-full object-cover rounded-full border hover:border-white border-transparent">
                            </div>
                          </div>
                          <div class="flex-1">
      ...
      inline-flex items-center" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                    <div class="lg:h-8 lg:w-8 h-7 w-7 rounded-full flex-1 ltr:mr-[10px] rtl:ml-[10px]">
                      <img :src="'/template_assets/images/all-img/user.png'" alt="user" class="block w-full h-full object-cover rounded-full">
                    </div>
